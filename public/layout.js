    ...
    nav.innerHTML = `
        <div class="w-full max-w-7xl mx-auto flex justify-between items-center h-full relative">
            <a href="index.html" class="flex items-center gap-2 md:gap-3 group">
                <img src="assets/logoweb.png" alt="Velo Insights Logo" class="w-12 h-12 md:w-14 md:h-14 object-contain group-hover:scale-110 transition-transform duration-300 drop-shadow-[0_0_10px_rgba(34,211,238,0.2)]">
