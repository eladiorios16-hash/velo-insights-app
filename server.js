...
// 3. CALENDARIO
// --- 🛠️ RUTA SECRETA: RECUPERACIÓN TOTAL DE DATOS ---
app.get('/api/fix-calendar', (req, res) => {
    ...
    // TUS DATOS ORIGINALES (Adaptados para Node.js)
    const insertQuery = `INSERT INTO calendario (id, name, date, category, details, dateISO, endDateISO, winner, status) VALUES
    ...
    (5, 'Strade Bianche', '07 Mar', 'WT', '{"stages":[{"n":1,"type":"mediamontaña","route":"Siena > Siena","km":201,"gain":3100,"image":"https://www.ciclo21.com/wp-content/uploads/2026/01/Strade-Bianche-2026-Altimetria.webp"}]}', '2026-03-07', '2026-03-07', NULL, 'Upcoming'),
    ...
    (8, 'Milano-Sanremo', '21 Mar', 'MONUMENT', '{"stages":[{"n":1,"type":"llano","route":"Pavia > Sanremo","km":293,"gain":2100,"image":"https://ciclored.com/wp-content/uploads/2022/02/Altimetria_milan_sanremo.jpg"}]}', '2026-03-21', '2026-03-21', NULL, 'Upcoming'),
    ...
    (14, 'Ronde van Vlaanderen', '05 Abr', 'MONUMENT', '{"stages":[{"n":1,"type":"mediamontaña","route":"Oudenaarde","km":270,"gain":2300}]}', '2026-04-05', '2026-04-05', NULL, 'Upcoming'),
    (15, 'Itzulia Basque Country', '06-11 Abr', 'WT', '{"stages":[{"n":1,"type":"tt","route":"Irun","km":10,"gain":150}]}', '2026-04-06', '2026-04-11', NULL, 'Upcoming'),
    (16, 'Paris-Roubaix', '12 Abr', 'MONUMENT', '{"stages":[{"n":1,"type":"llano","route":"Roubaix","km":260,"gain":800}]}', '2026-04-12', '2026-04-12', NULL, 'Upcoming'),
    ...
    (19, 'Liège-Bastogne-Liège', '26 Abr', 'MONUMENT', '{"stages":[{"n":1,"type":"mediamontaña","route":"Liège","km":259,"gain":4200}]}', '2026-04-26', '2026-04-26', NULL, 'Upcoming'),
    ...
    (24, 'Tour de France', '04-26 Jul', 'GT', '{\"stages":[{"n":1,"type":"TT","route":"Barcelona > Barcelona","km":"19","gain":"0","image":"https://www.ciclo21.com/wp-content/uploads/2025/10/Tour-Francia-1.jpg"},{"n":2,"type":"llano","route":"Tarragona > Barcelona","km":"182","gain":"0","image":"https://www.ciclo21.com/wp-content/uploads/2024/06/dd730.jpg"},{"n":3,"type":"mediamontaña","route":"Granollers > Les Angles","km":"196","gain":"3950","image":"https://www.ciclo21.com/wp-content/uploads/2025/10/Tour-Francia-3.jpg"},{"n":4,"type":"mediamontaña","route":"CCarcassonne > Foix ","km":182,"gain":"0","image":"https://www.ciclo21.com/wp-content/uploads/2025/10/Tour-Francia-4.jpg"},{"n":5,"type":"llano","route":"Lannemezan > Pau","km":158,"gain":"0 ","image":""},{"n":6,"type":"llano","route":"Pau > Gavarnie-Gèdre","km":186,"gain":"0","image":" "},{"n":7,"type":"llano","route":"Hagetmau > Burdeos","km":175,"gain":"0","image":" "},{"n":8,"type":"llano","route":" Périgueux > Bergerac","km":182,"gain":"0","image":" "},{"n":9,"type":"media montaña","route":" Malemort > Ussel","km":185,"gain":"0","image":"https://www.ciclo21.com/wp-content/uploads/2025/10/Tour-Francia-9.jpg"},{"n":10,"type":"media montaña","route":"Aurillac > Le Lioran","km":167,"gain":"0","image":"https://www.ciclo21.com/wp-content/uploads/2025/10/Tour-Francia-10.jpg"},{"n":11,"type":"llano","route":"Vichy > Nevers","km":161,"gain":"0","image":""},{"n":12,"type":"llano","route":"Circuito Nevers Magny-Cours > Chalon-sur-Saône","km":181,"gain":"0","image":""},{"n":13,"type":"llano","route":"Dole – Belfort ","km":205,"gain":"0","image":""},{"n":14,"type":"montaña","route":"Mulhouse > Le Markstein Fellering","km":155,"gain":"0","image":"https://www.ciclo21.com/wp-content/uploads/2025/10/Tour-Francia-14.jpg"},{"n":15,"type":"llano","route":"Champagnole > Plateau de Solaison","km":184,"gain":"0","image":""},{"n":16,"type":"tt","route":"Évian-les-Bains > Thonon-les-Bains","km":26,"gain":"0","image":"https://www.ciclo21.com/wp-content/uploads/2025/10/Tour-Francia-16.jpg"},{"n":17,"type":"llano","route":"Chambéry > Voiron","km":175,"gain":"0","image":""},{"n":18,"type":"montaña","route":"Voiron > Orcières-Merlette","km":185,"gain":"0","image":"https://www.ciclo21.com/wp-content/uploads/2025/10/Tour-Francia-18.jpg"},{"n":19,"type":"montaña","route":"Gap > Alpe d’Huez","km":128,"gain":"0","image":"https://www.ciclo21.com/wp-content/uploads/2025/10/Tour-Francia-19.jpg"},{"n":20,"type":"montaña","route":"Le Bourg d’Oisans > Alpe d’Huez","km":171,"gain":"0","image":"https://www.ciclo21.com/wp-content/uploads/2025/10/Tour-Francia-20.jpg"},{"n":21,"type":"llano","route":"Thoiry > Campos Elíseos de París","km":130,"gain":"0","image":""}]}', '2026-07-04', '2026-07-26', NULL, 'Upcoming'),
    ...
    (31, 'Il Lombardia', '10 Oct', 'MONUMENT', '{\"stages":[{"n":1,"type":"mediamontaña","route":"Bergamo","km":255}]}', '2026-10-10', '2026-10-10', NULL, 'Upcoming'),
    ...
    pool.query(dropQuery, (err) => {
        if(err) return res.status(500).send("❌ Error borrando: " + err.message);
        pool.query(createQuery, (err) => {
            if(err) return res.status(500).send("❌ Error creando: " + err.message);
            pool.query(insertQuery, (err) => {
                if(err) return res.status(500).send("❌ Error insertando: " + err.message);
                res.send("✅ BASE DE DATOS RECUPERADA AL 100%.");
            });
        });
    });
});
